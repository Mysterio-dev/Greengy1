(() => {
    ...
    ymaps.ready((function() {
        ...
        const collection = [ {
            ...
            properties: {
                hintContent: "Заправка 1",
                balloonContent: "Содержание заправка 1"
            }
        }, {
            type: "Feature",
            id: "2",
            geometry: {
                type: "Point",
                coordinates: [ 55.545, 37.63 ]
            },
            properties: {
                hintContent: "Заправка 2",
                balloonContent: "Содержание заправка 2"
            }
        }, {
            type: "Feature",
            id: "3",
            ...
            properties: {
                hintContent: "Заправка 3",
                balloonContent: "Содержание заправка 3"
            }
        } ];
